...
- [ ] **v0.2 — dictionary NER**: `gazetteer`, `rules` (hints, triggers),
  `ner` resolution, `nertest`/golden sets, CLI `extract`. Adds the
  dependency `go.yaml.in/yaml/v3` (approved 2026-09-24).
  [Plan](plans/2026-09-24-v0.2-ner.md).
- [ ] **v0.3 — patterns**: `rules` sequence patterns and facts, rule sets by
  document tags. [Plan](plans/2026-09-24-v0.3-patterns.md).
